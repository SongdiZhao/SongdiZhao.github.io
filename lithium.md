...
In this final project, I applied machine learning techniques to investigate the scarcity of lithium brine sources and the limitations of other extraction methods, such as hard rock and clay. Below is my report.
